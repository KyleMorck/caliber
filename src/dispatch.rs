...
fn parse_context(s: &str) -> Option<KeyContext> {
    match s {
        ...
        "datepicker" => Some(KeyContext::Datepicker),
        _ => None,
    }
}
...
fn parse_action_id(s: &str) -> Option<KeyActionId> {
    match s {
        ...
        "open_datepicker" => Some(KeyActionId::OpenDatepicker),
        ...
        "datepicker_move_left" => Some(KeyActionId::DatepickerMoveLeft),
        "datepicker_move_right" => Some(KeyActionId::DatepickerMoveRight),
        "datepicker_move_up" => Some(KeyActionId::DatepickerMoveUp),
        "datepicker_move_down" => Some(KeyActionId::DatepickerMoveDown),
        "datepicker_prev_month" => Some(KeyActionId::DatepickerPrevMonth),
        "datepicker_next_month" => Some(KeyActionId::DatepickerNextMonth),
        "datepicker_prev_year" => Some(KeyActionId::DatepickerPrevYear),
        "datepicker_next_year" => Some(KeyActionId::DatepickerNextYear),
        "datepicker_today" => Some(KeyActionId::DatepickerToday),
        "datepicker_confirm" => Some(KeyActionId::DatepickerConfirm),
        "datepicker_cancel" => Some(KeyActionId::DatepickerCancel),
